...
local web = true
local user = "Fl0werHakeS" -- change if you're using a fork
local importCache = {}
...
local globalMethods = {
    ...
    getScriptClosure = get_script_function or getscriptclosure, -- (removed until exploits fix) get_script_function or getscriptclosure,
